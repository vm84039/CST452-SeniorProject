...
@section('content')
    <div  class="portfolio" style="margin-left: 250px">
        ...
        <div style="margin-right: 150px; overflow-wrap: break-word;background:white; color: black; padding: 50px">
            <h1 style="text-align: center; margin-bottom: 50px;line-height: 2">About Me</h1>
            ...
            I utilized Aspect DataCenter to perform live queries and customized views to suit many needs.<br><br>
